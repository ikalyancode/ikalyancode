...
export const ExperienceCard: React.FC<ExperienceCardProps> = ({ job, isFirst }) => {
  return (
    <div className="relative pl-12 group">
       <div className={`absolute left-3 top-6  h-4 w-4 rounded-full border-2 border-white dark:border-slate-900 shadow-md ${isFirst ? 'bg-gradient-to-br from-cyan-500 to-purple-500 animate-pulse' : 'bg-slate-300 dark:bg-slate-700 group-hover:bg-cyan-400 group-hover:shadow-cyan-500/50'} transition-all duration-300`}></div>
