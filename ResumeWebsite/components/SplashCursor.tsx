...
const SplashCursor: React.FC<SplashCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const contextInfo = getWebGLContext(canvas);
    const gl = contextInfo.gl;
    const ext = contextInfo.ext;
    ...
    function getWebGLContext(targetCanvas: HTMLCanvasElement) {
      ...
      const glContext =
        (targetCanvas.getContext('webgl2', params) as any) ||
        (targetCanvas.getContext('webgl', params) as any) ||
        (targetCanvas.getContext('experimental-webgl', params) as any);

      if (!glContext) {
        throw new Error('WebGL is not supported in this browser.');
      }

      const isWebGL2 = !!glContext.drawBuffers;
      let halfFloat: any;
    ...
    function getSupportedFormat(glContext: any, internalFormat: any, format: any, type: any) {
    ...
    function supportRenderTextureFormat(glContext: any, internalFormat: any, format: any, type: any) {
    ...
    function updateKeywords() {
      const displayKeywords = [] as string[];
